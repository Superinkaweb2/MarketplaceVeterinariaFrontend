      ...
      <section className="max-w-7xl mx-auto px-4 pb-24">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <form className="bg-white p-8 md:p-10 rounded-2xl shadow-soft border border-slate-100 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select className="w-full px-4 py-3 rounded-lg border border-slate-200 bg-slate-50 focus:ring-2 focus:ring-[#1ea59c] outline-none transition-all appearance-none">
