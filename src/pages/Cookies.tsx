        ...
        <div className="max-w-3xl mx-auto px-6 py-16 flex-1 w-full bg-white">
            ...
            <div className="prose max-w-none text-slate-600 space-y-6">
                ...
                <ul className="list-disc pl-6 space-y-2">
                    <li>Mantener abierta la sesión del Usuario o Vendedor de forma segura mientras navega.</li>
                    <li>Recordar los productos (alimentos, accesorios) o servicios añadidos al carrito de compras.</li>
                ...
                <ul className="list-disc pl-6 space-y-2">
                    <li>El idioma seleccionado por el usuario.</li>
                    <li>La ubicación geográfica o distrito del usuario (necesario para calcular los costos de delivery de los vendedores).</li>
                ...
                <ul className="list-disc pl-6 space-y-2">
                    <li>Qué categorías de productos o servicios veterinarios son las más visitadas.</li>
                    <li>El tiempo de permanencia de los usuarios dentro de la plataforma.</li>
                ...
                <ul className="list-disc pl-6 space-y-2">
                    <li>Mostrar anuncios relevantes sobre cuidado de mascotas en plataformas externas (como redes sociales).</li>
                    <li>Limitar el número de veces que un usuario ve un mismo anuncio publicitario.</li>
                ...
                <ul className="list-disc pl-6 space-y-2">
                    <li>Pasarelas de pago autorizadas para el procesamiento seguro de transacciones bancarias.</li>
                    <li>Proveedores de mapas interactivos para la geolocalización de clínicas veterinarias y pet shops aliados.</li>
                ...
                <ul className="list-disc pl-6 space-y-2">
                    <li><strong>Cookies de Soporte en Vivo y Chats Interactivos:</strong> Utilizadas para reconocer la identidad de los usuarios que realizan consultas de soporte en tiempo real.</li>
