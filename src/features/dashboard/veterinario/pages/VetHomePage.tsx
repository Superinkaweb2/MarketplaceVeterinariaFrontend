...
export const VetHomePage = () => {
 ...
 <div
 key={inv.idStaff}
 className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl bg-slate-50 border border-slate-100 "
 >
 ...
 className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-slate-200 hover:bg-slate-300 :bg-slate-600 text-slate-700 text-sm font-medium transition-colors"
 >
 <X size={16} /> Rechazar
 </button>
 </div>
