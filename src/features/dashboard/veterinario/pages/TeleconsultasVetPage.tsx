...
export const TeleconsultasVetPage = () => {
 ...
 return (
  <div className="space-y-6 animate-in fade-in duration-500">
   <div>
    <h1 className="text-2xl font-extrabold text-gray-900">Teleconsultas</h1>
    <p className="text-sm text-slate-500 mt-1">Gestiona las consultas virtuales con tus pacientes.</p>
   </div>
   ...
   {loading ? (
    ...
    <div className="text-center py-20 bg-white rounded-2xl border border-slate-100">
     ...
     <h3 className="text-lg font-bold text-slate-700">No hay teleconsultas</h3>
     <p className="text-slate-400 mt-1">Las consultas de tus pacientes aparecerán aquí.</p>
    </div>
   ) : (
    <div className="space-y-3">
     {consultas.map((c) => (
      <button
       ...
       className="w-full flex items-center justify-between bg-white border border-slate-100 rounded-2xl p-5 hover:shadow-md hover:border-teal-500/20 transition-all text-left"
      >
       <div className="flex items-center gap-4">
        ...
        <div>
         <p className="font-semibold text-slate-800">{c.clienteNombre}</p>
