...
export const TopHeader = ({ onMenuClick }: TopHeaderProps) => {
 ...
 return (
 <header className="h-16 flex items-center justify-between px-6 bg-white border-b border-gray-200 flex-shrink-0 z-20">
 {/* Mobile Menu Toggle */}
 <button
 onClick={onMenuClick}
 className="lg:hidden mr-4 p-2 text-gray-600 hover:bg-gray-100 :bg-surface-darker rounded-lg transition-colors"
 >
 <Menu size={24} />
 </button>
 ...
 <input
 className="w-full bg-gray-50 border border-gray-200 rounded-xl py-2 pl-11 pr-4 text-sm focus:ring-2 focus:ring-primary focus:border-primary placeholder-gray-400 outline-none transition-all"
