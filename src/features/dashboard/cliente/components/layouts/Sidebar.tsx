...
export const Sidebar = ({ isMobileOpen, setMobileOpen }: SidebarProps) => {
 ...
 <button
 onClick={() => setMobileOpen(false)}
 className="lg:hidden p-2 text-gray-400 hover:text-gray-600 :text-gray-200 rounded-lg"
 >
 <X size={20} />
 </button>
 {isCollapsed && (
 ...
 className="hidden lg:flex p-1.5 rounded-lg hover:bg-gray-100 :bg-surface-darker text-gray-400 hover:text-gray-600 transition-colors"
 >
 <ChevronLeft size={18} className={`transition-transform duration-300 ${isCollapsed ? "rotate-180" : ""}`} />
 </button>
 <button
 onClick={() => setMobileOpen(false)}
 className="lg:hidden p-1.5 rounded-lg hover:bg-gray-100 :bg-surface-darker text-gray-400"
 >
 <X size={20} />
 </button>
 </div>
 ...
 className={`
 flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-gray-600 hover:bg-gray-50 :bg-surface-darker hover:text-gray-900 transition-all
 ...
 onClick={logout}
 className={`
 w-full flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium text-red-500 hover:bg-red-50 :bg-red-950/20 transition-all
 ${isCollapsed ? "justify-center" : ""}
 `}
 >
 <LogOut size={20} />
