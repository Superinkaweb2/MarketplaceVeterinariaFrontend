...
export const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed md:relative z-50 h-full w-64 flex-col bg-white border-r border-slate-200 
      ...
      >
        <div className="flex h-full flex-col justify-between p-4">
          ...
          {/* Bottom Nav */}
          <div className="flex flex-col gap-1 border-t border-slate-100 pt-4 mt-auto">
            <NavItem
            ...
            {/* LogOut handled here */}
            <button
              className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg transition-colors text-red-500 hover:bg-red-50"
