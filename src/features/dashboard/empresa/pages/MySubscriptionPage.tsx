...
export const MySubscriptionPage = () => {
    ...
    const handleUpgrade = async (plan: Plan) => {
        ...
        const result = await Swal.fire({
            ...
            text: `Se actualizarán tus límites a ${plan.limiteMascotas === 0 ? 'Ilimitadas' : plan.limiteMascotas} mascotas y ${plan.limiteProductos === 0 ? 'Ilimitados' : plan.limiteProductos} productos.`,
            icon: 'question',
        ...
        if (result.isConfirmed) {
            try {
                ...
                Swal.fire({
                    ...
                    text: 'Tu suscripción ha sido actualizada correctamente.',
                    icon: 'success',
                    timer: 2000,
