...
export default function Dashboard() {
 ...
 <div className="lg:col-span-3 bg-white/40 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/40 shadow-soft group">
 <div className="flex items-center justify-between mb-8">
 <div className="flex items-center gap-3">
 <div className="p-2.5 bg-[#2D3E82]/10 rounded-xl text-[#2D3E82]">
 <BarChart3 size={20} strokeWidth={2.5} />
 </div>
 <h2 className="text-xl font-black text-[#2D3E82] tracking-tight">
 Ventas Marketplace
 </h2>
 </div>
 <select className="text-xs font-bold bg-[#f6f8f8] border-none rounded-full px-4 py-2 text-gray-500 cursor-pointer outline-none focus:ring-2 focus:ring-[#1ea59c]/20">
 ...
 <div className="lg:col-span-2 bg-white/40 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/40 shadow-soft">
 ...
 <div className="mt-4 p-4 bg-[#1ea59c]/5 #1ea59c]/10 rounded-2xl">
 ...
 {/* 4. Activity Table */}
 <div className="bg-white/40 backdrop-blur-xl rounded-[2.5rem] border border-white/40 shadow-soft overflow-hidden">
