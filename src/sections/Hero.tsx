      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-secondary mb-6 leading-tight">
              La Plataforma
          ...
          <div className="relative lg:h-auto group">
            ...
            <div className="absolute -top-20 -right-20 w-96 h-96 bg-primary/10 rounded-full blur-3xl transition-opacity duration-1000 group-hover:opacity-80"></div>
            <div className="absolute bottom-0 left-0 w-72 h-72 bg-secondary/10 rounded-full blur-3xl transition-opacity duration-1000 group-hover:opacity-80"></div>

            <img
              alt="Veterinario examinando a un perro"
              className="relative rounded-full shadow-2xl border-4 border-white z-10 transform rotate-1 group-hover:rotate-0 transition-transform duration-500 w-full object-cover aspect-square"
